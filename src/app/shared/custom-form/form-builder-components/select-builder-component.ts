...
@Component({
  selector: 'select-builder-widget',
  template: `
  <div>
  ...
  <div style="display: grid;padding:0.5rem 0rem;row-gap: 0.5rem;">
    ...
    <div style="display: flex;"><span class="add-options" (click)="addOption()">Add Another</span></div>
  </div> 
  </div>`,
  styles: [`
