  ...
  *ngIf="!mode"
  ...
  >
    ...
    <div>
      ...
      style="display: grid;grid-template-columns:repeat(2,1fr);padding:0.5rem 0rem;">
...
export class YesNoViewerComponent implements OnInit {
    @Input() schema:any;
    @Input() path:any;
